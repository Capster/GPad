...
function PANEL:Init ()
	xpcall (function ()
		...
		GPad.AddToolbarItem("Open (CTRL + O)", "icon16/folder_page_white.png", null)
		GPad.AddToolbarItem("Save (CTRL + S)", "icon16/disk.png", null)
		GPad.AddToolbarItem("Save As (CTRL + ALT + S)", "icon16/disk_multiple.png", null)
